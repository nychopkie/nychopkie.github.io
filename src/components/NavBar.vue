         ...
         <div class="md:hidden z-30">
            ...
            @click="isMenuOpen = !isMenuOpen">
                <span v-if="isMenuOpen" class="text-5xl">
                    <img src="https://img.icons8.com/?size=100&id=46&format=png&color=000000" alt="close" width="50" height="50"/>
                </span>
                <span v-else class="text-5xl">
                    <img src="https://img.icons8.com/?size=100&id=36389&format=png&color=000000" alt="menu" width="50" height="50"/>
                </span>
            </button>
         </div>
